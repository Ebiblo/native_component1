...
const BottomSheetDraggableViewComponent = ({
  ...
  const simultaneousHandlers = (0, _react.useMemo)(() => nativeGestureRef ? [rootTapGestureRef, nativeGestureRef] : rootTapGestureRef, [rootTapGestureRef, nativeGestureRef]); // styles
