...
export declare type BottomSheetMethods = {
    /**
...
export declare type Scrollable = FlatList | ScrollView | SectionList;
export declare type ScrollableType = 'FlatList' | 'ScrollView' | 'SectionList' | 'View';
export declare type ScrollableRef = {
    id: number;
    node: Scrollable;
    type: ScrollableType;
};
 ...
 * Modal types
 */
export declare type BottomSheetModalConfigs = {
    /**
